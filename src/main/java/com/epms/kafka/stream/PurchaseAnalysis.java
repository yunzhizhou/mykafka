...
import com.epms.kafka.stream.serdes.SerdesFactory;
import com.epms.kafka.stream.timeextractor.OrderTimestampExtractor;
...
public class PurchaseAnalysis {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		props.put(StreamsConfig.ZOOKEEPER_CONNECT_CONFIG, "zoo1:2181");
